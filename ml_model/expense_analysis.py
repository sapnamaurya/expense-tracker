...
# Round Price Per Unit for clustering consistency (already rounded in CSV, but ensure here)
...
# Disable scientific notation on y-axis and remove "1e6" label
plt.ticklabel_format(style='plain', axis='y')
# Format y-axis labels with commas for readability (e.g., 1,000,000)
...
next_pred = round(model.predict([[next_index, next_month_num]])[0])  # Round prediction to whole number
